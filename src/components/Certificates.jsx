...
import img2 from '../assets/images/sertifikat.jpeg'; // Sesuaikan nama file kamu
...
const Certificates = () => {
  return (
    <section className="py-24 px-6 max-w-7xl mx-auto relative" id="sertifikat">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6 relative z-10">
        ...
        <a href="#" className="group flex items-center gap-2 text-green-400 font-mono text-sm border border-green-500/30 px-4 py-2 rounded-lg hover:bg-green-500/10 transition-all">
        ...
        {certificates.map((cert) => (
          <div key={cert.id} className="group relative bg-[#0a0a0a] border border-white/10 rounded-2xl overflow-hidden hover:border-green-500/50 transition-all duration-500 hover:shadow-[0_0_30px_rgba(34,197,94,0.15)] hover:-translate-y-2">
            ...
            <div className="h-56 overflow-hidden relative">
              ...
              {/* Efek Garis Scan Hijau saat Hover */}
              ...
              <div className="absolute top-4 left-4 z-20">
                 <span className="px-3 py-1 text-[10px] font-bold tracking-widest uppercase bg-black/80 backdrop-blur-md text-green-400 border border-green-500/30 rounded-full">
                    {cert.category}
                 </span>
              </div>
            </div>
            ...
            <div className="p-6 relative">
              ...
              <h3 className="text-lg font-bold text-white leading-snug mb-4 group-hover:text-green-400 transition-colors">
                {cert.title}
              </h3>

              {/* Footer Kartu: ID & Link */}
              <div className="flex items-center justify-between pt-4 border-t border-white/5">
                 <code className="text-[10px] text-gray-600 font-mono bg-white/5 px-2 py-1 rounded">
                    {cert.credentialId}
                 </code>
                 
                 <a href={cert.link} className="p-2 rounded-full bg-white/5 text-white hover:bg-green-500 hover:text-black transition-all transform hover:rotate-45">
